...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final username = userProvider.currentUser?.name ?? authProvider.currentUser?.displayName ?? '';
    final email = authProvider.currentUser?.email ?? userProvider.currentUser?.email ?? '';
    final photoUrl = userProvider.currentUser?.photoUrl ?? authProvider.currentUser?.photoURL ?? '';
            ...
            TextButton(
              onPressed: () async {
                ...
                if (newUsername.isNotEmpty) {
                  await context
                      .read<UserProvider>()
                      .updateUserName(context, newUsername, userId);
                  if (context.mounted) {
                    Navigator.pop(context);
                  }
                } else {
